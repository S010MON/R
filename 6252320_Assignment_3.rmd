...
\end{array}
$$
As integrating the PDF gives us the CDF, and integrating between the median ($m$) and $1$ (or $0$ and $m$) should give us a probability of $0.5$ we can derive:
$$
\int_{0}^{1} f(x) \text{ }dx =  \int_{0}^{1} 30x^{4} - 30x^{5} \text{ }dx = \frac{30}{5}x^{5} - \frac{30}{6}x^{6} = 6x^{5} - 5x^{6}
$$
Thus we can define a new function from the integral and set it to 0.5 which will be the value of the area under the range $0$ to $m$:
$$
\begin{array}{rcl}
g(x) & = & 6x^{5} - 5x^{6} = 0.5 \\
 & = & 6x^{5} - 5x^{6} - 0.5 = 0\\
